...
function myMap()
            {
            myCenter=new google.maps.LatLng(41.880650,-87.675140);
            var mapOptions= {
            center:myCenter,
            ...
            function makeTextBox(i){	//this function makes the info box that appears everytime you click on a marker 
              ...
              var eventsInfo = '<div id="events">'
                        + '<h1 id="Title">'
                        + byEvents[i].title
                        + '</h1>'
                        + byEvents[i].performers["0"]
                        + '">'
                        + byEvents[i].datetime_local
                       + '</div>';
              //}
      ...
      function makeMarkers(){	//this function creates the markers that will appear on the map
        ...
        //creating and putting the markers on the map
          for(var i =0; i < byEvents.length; i++){
              var myLatLng = {lat: byEvents[i].byVenues.latitude, lng: byEvents[i].byVenues.longitude};
              marker = new google.maps.Marker({
                 position: myLatLng,
                 map: theMap,
                 title: byEvents[i].title
              });
